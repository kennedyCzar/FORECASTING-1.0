...
Forecasting 1.0 is an intellient model for time-series prediction and forecasting. Implemented using ensemble models, Boosting Model and Recurrent Neural Network.
