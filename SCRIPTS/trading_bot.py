# -*- coding: utf-8 -*-
"""
Created on Mon Oct  1 18:07:47 2018
...
# select years
start_year = 2016           # data is 1900-2017 pick year to start training 
end_year = 2018

# bot stuff
seed_money = 1000.         # starting cash for bots
...
# read in NASDAQ
stock_data = web.DataReader('GOOGL', "yahoo", start_year, end_year)
